...
void test_power()//Modified this for Lab
{
	TEST_ASSERT_EQUAL_UINT8(255, (power(2, 8)-1));
}
void test_power_overflow()//Modified this for Lab
{
	TEST_ASSERT_EQUAL_UINT8(0, power(2, 9));
}
...
void test_magnitude()
{
	TEST_ASSERT_EQUAL_INT(8, magnitude(8));
}
void test_magnitude2() //This one should fail
{
	TEST_ASSERT_EQUAL_INT(-8, magnitude(8));
}
void test_magnitude3()
{
	TEST_ASSERT_EQUAL_INT(8, magnitude(-8));
}
void setUp()
...
int main(void)
{
	...
	RUN_TEST(test_magnitude2);
	RUN_TEST(test_magnitude3);
